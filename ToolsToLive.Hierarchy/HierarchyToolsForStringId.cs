...
{
    public static class HierarchyToolsForStringId
    {
        /// <summary>
        ...
        public static List<T> ToHierarhyList<T>(this IEnumerable<T> source, string selectedId) where T : class, IHierarchyItem<T, string, string>
        {
        ...
        /// <param name="source">Flat list of the elements.</param>
        /// <returns>Hierarchy list.</returns>
        public static List<T> ToHierarhyList<T>(this IEnumerable<T> source) where T : IHierarchyItem<T, string, string>
        {
            int level = 1;
        ...
        private static List<T> AddChilds<T>(T element, IEnumerable<T> allelements, int level) where T : IHierarchyItem<T, string, string>
        {
        ...
        public static T FindElement<T>(IEnumerable<T> allElementsList, string Id) where T : class, IHierarchyItem<T, string, string>
        {
        ...
        public static List<T> FindChilds<T>(IEnumerable<T> allElementsList, string hostId) where T : IHierarchyItem<T, string, string>
        {
        ...
        /// <returns>List of element (empty list if elements not found).</returns>
        public static List<T> FindParents<T>(IHierarchyItem<T, string, string> element) where T : IHierarchyItem<T, string, string>
        {
